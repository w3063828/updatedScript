PARAMETER endPoint,maxSpeed IS 15,minSpeed IS 5,closeToDist IS 450,roverAccel IS 0.05,turnCoeff IS 1.7,unitDist IS 2000.
RUNONCEPATH("0:/lib/lib_geochordnate.ks").
...
//	WAIT UNTIL RCS.
	...
	IF NOT SAS {
		RUNPATH("0:/Rover_Path_execution",maxSpeed,minSpeed,closeToDist,waypointList,unitDist / 4,destName,roverAccel,turnCoeff).
	}
}}
ABORT OFF.
CLEARVECDRAWS().
