...
RUNONCEPATH("0:/lib/lib_orbital_math.ks").
RUNONCEPATH("0:/lib/lib_rocket_utilities").
RUNONCEPATH("0:/lib/lib_formating.ks").
RUNONCEPATH("0:/lib/lib_hill_climb.ks").
...
FUNCTION closest_approach_hill{
	PARAMETER object1, object2, startTime.
...
FUNCTION refine_score {
	PARAMETER mNode.
	SET curentClose TO closest_approach_hill(SHIP,TARGET,mNode:ETA + TIME:SECONDS)["dist"].
	global score IS ABS(curentClose - 400) + mNode:DELTAV:MAG.
