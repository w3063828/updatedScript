...
function GS{ 
     ...
     local GG IS body:geopositionOf(center - 05 * north:vector + 05 * east).  
     ...
     local y IS body:geopositionOf(center + 10 * north:vector - 10 * east).  
        ...
        local Gg_vec is gg:altitudeposition(GG:terrainheight).
        ...
        local y_vec is y:altitudeposition(y:terrainheight).
            ...
            local sq1 is vcrs(a_vec - gg_vec, f_vec - b_vec).
            local sq2 is vcrs(b_vec - h_vec, gg_vec - c_vec).
            local sq3 is vcrs(c_vec - i_vec, h_vec - d_vec).
            local sq4 is vcrs(d_vec - j_vec, i_vec - e_vec).

            local sq5 is vcrs(f_vec - l_vec, k_vec - gg_vec).
            local sq6 is vcrs(gg_vec - m_vec, l_vec - h_vec).
...
function GSDf { 
     ...
     local center1 is (addons:tr:impactpos:position).
