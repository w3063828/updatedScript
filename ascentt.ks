...
SET Sidetank1 TO SHIP:PARTSDUBBED("SOLIDtank1")[0].
    FOR res IN Sidetank1:RESOURCES {
...
function main {
  ...
  until apoapsis > 105000 {
    ...
    if LF:amount < 27500 or altitude > 40000 {
      ag8 on.}
    if SF:amount < 1 {
      ag9 on.}
 }
