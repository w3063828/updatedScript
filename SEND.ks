...
function hell_cat{
 if abs(sq1a) > abs(sq2a) and abs(sq1a) > abs(sq3a) and abs(sq1a) > abs(sq4a) and abs(sq1a) > abs(sq5a) and abs(sq1a) > abs(sq6a) and abs(sq1a) > abs(sq7a) and abs(sq1a) > abs(sq8a) and abs(sq1a) > abs(sq9a) and abs(sq1a) > abs(sq10a) and abs(sq1a) > abs(sq11a) and abs(sq1a) > abs(sq12a) and abs(sq1a) > abs(sq13a) and abs(sq1a) > abs(sq14a) and abs(sq1a) > abs(sq15a) and abs(sq1a) > abs(sq16a)    {set gp to xxb.}
 if abs(sq2a) > abs(sq1a) and abs(sq2a) > abs(sq3a) and abs(sq2a) > abs(sq4a) and abs(sq2a) > abs(sq5a) and abs(sq2a) > abs(sq6a) and abs(sq2a) > abs(sq7a) and abs(sq2a) > abs(sq8a) and abs(sq2a) > abs(sq9a) and abs(sq2a) > abs(sq10a) and abs(sq2a) > abs(sq11a) and abs(sq2a) > abs(sq12a) and abs(sq2a) > abs(sq13a) and abs(sq2a) > abs(sq14a) and abs(sq2a) > abs(sq15a) and abs(sq2a) > abs(sq16a)   {set gp to xxc.}
 ...
 if abs(sq4a) > abs(sq1a) and abs(sq4a) > abs(sq2a) and abs(sq4a) > abs(sq3a) and abs(sq4a) > abs(sq5a) and abs(sq4a) > abs(sq6a) and abs(sq4a) > abs(sq7a) and abs(sq4a) > abs(sq8a) and abs(sq4a) > abs(sq9a) and abs(sq4a) > abs(sq10a) and abs(sq4a) > abs(sq11a) and abs(sq4a) > abs(sq12a) and abs(sq4a) > abs(sq13a) and abs(sq4a) > abs(sq14a) and abs(sq4a) > abs(sq15a) and abs(sq4a) > abs(sq16a)   {set gp to xxa.} 
 if abs(sq5a) > abs(sq1a) and abs(sq5a) > abs(sq2a) and abs(sq5a) > abs(sq3a) and abs(sq5a) > abs(sq4a) and abs(sq5a) > abs(sq6a) and abs(sq5a) > abs(sq7a) and abs(sq5a) > abs(sq8a) and abs(sq5a) > abs(sq9a) and abs(sq5a) > abs(sq10a) and abs(sq5a) > abs(sq11a) and abs(sq5a) > abs(sq12a) and abs(sq5a) > abs(sq13a) and abs(sq5a) > abs(sq14a) and abs(sq5a) > abs(sq15a) and abs(sq5a) > abs(sq16a)   {set gp to xxe.}
 if abs(sq6a) > abs(sq1a) and abs(sq6a) > abs(sq3a) and abs(sq6a) > abs(sq4a) and abs(sq6a) > abs(sq5a) and abs(sq6a) > abs(sq2a) and abs(sq6a) > abs(sq7a) and abs(sq6a) > abs(sq8a) and abs(sq6a) > abs(sq9a) and abs(sq6a) > abs(sq10a) and abs(sq6a) > abs(sq11a) and abs(sq6a) > abs(sq12a) and abs(sq6a) > abs(sq13a) and abs(sq6a) > abs(sq14a) and abs(sq6a) > abs(sq15a) and abs(sq6a) > abs(sq16a)   {set gp to xxf.}
 if abs(sq7a) > abs(sq1a) and abs(sq7a) > abs(sq3a) and abs(sq7a) > abs(sq4a) and abs(sq7a) > abs(sq5a) and abs(sq7a) > abs(sq6a) and abs(sq7a) > abs(sq2a) and abs(sq7a) > abs(sq8a) and abs(sq7a) > abs(sq9a) and abs(sq7a) > abs(sq10a) and abs(sq7a) > abs(sq11a) and abs(sq7a) > abs(sq12a) and abs(sq7a) > abs(sq13a) and abs(sq7a) > abs(sq14a) and abs(sq7a) > abs(sq15a) and abs(sq7a) > abs(sq16a)   {set gp to xxg.}
 if abs(sq8a) > abs(sq1a) and abs(sq8a) > abs(sq3a) and abs(sq8a) > abs(sq4a) and abs(sq8a) > abs(sq5a) and abs(sq8a) > abs(sq6a) and abs(sq8a) > abs(sq7a) and abs(sq8a) > abs(sq2a) and abs(sq8a) > abs(sq9a) and abs(sq8a) > abs(sq10a) and abs(sq8a) > abs(sq11a) and abs(sq8a) > abs(sq12a) and abs(sq8a) > abs(sq13a) and abs(sq8a) > abs(sq14a) and abs(sq8a) > abs(sq15a) and abs(sq8a) > abs(sq16a)   {set gp to xxh.}
 ...
 if abs(sq10a) > abs(sq1a) and abs(sq10a) > abs(sq3a) and abs(sq10a) > abs(sq4a) and abs(sq10a) > abs(sq5a) and abs(sq10a) > abs(sq6a) and abs(sq10a) > abs(sq7a) and abs(sq10a) > abs(sq8a) and abs(sq10a) > abs(sq9a) and abs(sq10a) > abs(sq2a) and abs(sq10a) > abs(sq11a) and abs(sq10a) > abs(sq12a) and abs(sq10a) > abs(sq13a) and abs(sq10a) > abs(sq14a) and abs(sq10a) > abs(sq15a) and abs(sq10a) > abs(sq16a)   {set gp to xxj.}
 if abs(sq11a) > abs(sq1a) and abs(sq11a) > abs(sq3a) and abs(sq11a) > abs(sq4a) and abs(sq11a) > abs(sq5a) and abs(sq11a) > abs(sq6a) and abs(sq11a) > abs(sq7a) and abs(sq11a) > abs(sq8a) and abs(sq11a) > abs(sq9a) and abs(sq11a) > abs(sq10a) and abs(sq11a) > abs(sq11a) and abs(sq2a) > abs(sq12a) and abs(sq11a) > abs(sq13a) and abs(sq11a) > abs(sq14a) and abs(sq11a) > abs(sq15a) and abs(sq11a) > abs(sq16a)   {set gp to xxk.}
 if abs(sq12a) > abs(sq1a) and abs(sq12a) > abs(sq3a) and abs(sq12a) > abs(sq4a) and abs(sq12a) > abs(sq5a) and abs(sq12a) > abs(sq6a) and abs(sq12a) > abs(sq7a) and abs(sq12a) > abs(sq8a) and abs(sq12a) > abs(sq9a) and abs(sq12a) > abs(sq10a) and abs(sq12a) > abs(sq11a) and abs(sq12a) > abs(sq2a) and abs(sq12a) > abs(sq13a) and abs(sq12a) > abs(sq14a) and abs(sq12a) > abs(sq15a) and abs(sq12a) > abs(sq16a)  {set gp to xxl.}
 if abs(sq13a) > abs(sq1a) and abs(sq13a) > abs(sq3a) and abs(sq13a) > abs(sq4a) and abs(sq13a) > abs(sq5a) and abs(sq13a) > abs(sq6a) and abs(sq13a) > abs(sq7a) and abs(sq13a) > abs(sq8a) and abs(sq13a) > abs(sq9a) and abs(sq13a) > abs(sq10a) and abs(sq13a) > abs(sq11a) and abs(sq13a) > abs(sq12a) and abs(sq13a) > abs(sq2a) and abs(sq13a) > abs(sq14a) and abs(sq13a) > abs(sq15a) and abs(sq13a) > abs(sq16a)   {set gp to xxm.}
 if abs(sq14a) > abs(sq1a) and abs(sq14a) > abs(sq3a) and abs(sq14a) > abs(sq4a) and abs(sq14a) > abs(sq5a) and abs(sq14a) > abs(sq6a) and abs(sq14a) > abs(sq7a) and abs(sq14a) > abs(sq8a) and abs(sq14a) > abs(sq9a) and abs(sq14a) > abs(sq10a) and abs(sq14a) > abs(sq11a) and abs(sq14a) > abs(sq12a) and abs(sq14a) > abs(sq13a) and abs(sq14a) > abs(sq02a) and abs(sq14a) > abs(sq15a) and abs(sq14a) > abs(sq16a)  {set gp to xxn.}
 if abs(sq15a) > abs(sq1a) and abs(sq15a) > abs(sq2a) and abs(sq15a) > abs(sq3a) and abs(sq15a) > abs(sq4a) and abs(sq15a) > abs(sq5a) and abs(sq15a) > abs(sq6a) and abs(sq15a) > abs(sq7a) and abs(sq15a) > abs(sq8a) and abs(sq15a) > abs(sq9a)  and abs(sq15a) > abs(sq10a) and abs(sq15a) > abs(sq11a) and abs(sq15a) > abs(sq12a) and abs(sq15a) > abs(sq13a) and abs(sq15a) > abs(sq14a) and abs(sq15a) > abs(sq16a)  {set gp to xxo.}
 if abs(sq16a) > abs(sq1a) and abs(sq16a) > abs(sq3a) and abs(sq16a) > abs(sq4a) and abs(sq16a) > abs(sq5a) and abs(sq16a) > abs(sq6a) and abs(sq16a) > abs(sq7a) and abs(sq16a) > abs(sq8a) and abs(sq16a) > abs(sq9a) and abs(sq16a) > abs(sq10a) and abs(sq16a) > abs(sq11a) and abs(sq16a) > abs(sq12a) and abs(sq16a) > abs(sq13a) and abs(sq16a) > abs(sq14a) and abs(sq16a) > abs(sq15a) and abs(sq16a) > abs(sq2a)  {set gp to xxp.}
print gp.
}
